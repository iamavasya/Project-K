...
description: 'Як повідомити про вразливість і які версії підтримуються.'
sidebar:
  order: 4
---

:::note[Джерело]
Ця сторінка збирається з [`SECURITY.md`](https://github.com/iamavasya/Project-K/blob/main/SECURITY.md) у репозиторії. Правити треба там.
:::
