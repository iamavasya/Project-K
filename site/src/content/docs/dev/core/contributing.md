---
title: 'Конвенції ProjectK'
description: 'Конвенції, за якими пишеться новий код.'
sidebar:
  order: 2
---

:::note[Джерело]
Ця сторінка збирається з [`CONTRIBUTING.md`](https://github.com/iamavasya/Project-K/blob/main/CONTRIBUTING.md) у репозиторії. Правити треба там.
:::
