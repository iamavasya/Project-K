---
title: 'Оновлення self-host-інсталяції'
description: 'Оновлення self-host-інсталяції.'
sidebar:
  order: 3
---

:::note[Джерело]
Ця сторінка збирається з [`docs/self-host/update.md`](https://github.com/iamavasya/Project-K/blob/main/docs/self-host/update.md) у репозиторії. Правити треба там.
:::
...
2. Зроби [копії бази і файлів](/dev/self-host/backup-restore/).
