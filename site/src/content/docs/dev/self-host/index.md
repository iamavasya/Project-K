---
title: 'Self-host Лілейки'
description: 'Поставити Лілейку на власний сервер.'
sidebar:
  order: 1
---

:::note[Джерело]
Ця сторінка збирається з [`docs/self-host/README.md`](https://github.com/iamavasya/Project-K/blob/main/docs/self-host/README.md) у репозиторії. Правити треба там.
:::
...
Далі: [оновлення](/dev/self-host/update/), [резервні копії](/dev/self-host/backup-restore/).
