---
title: 'Резервні копії та відновлення'
description: 'Резервні копії та відновлення.'
sidebar:
  order: 2
---

:::note[Джерело]
Ця сторінка збирається з [`docs/self-host/backup-restore.md`](https://github.com/iamavasya/Project-K/blob/main/docs/self-host/backup-restore.md) у репозиторії. Правити треба там.
:::
