...
describe('MemberCardComponent', () => {
  ...
  beforeEach(async () => {
    ...
    paramMapSubject = new BehaviorSubject<ParamMap>(convertToParamMap({ memberKey }));
  ...
  it('should navigate to group page on load error when existing member with groupKey set', () => {
    ...
    createComponent();
    fixture.detectChanges();
    // simulate next fetch failing while component.member already set
  ...
  it('refreshData should use latest paramMap value if it changes', () => {
    memberServiceSpy.getByKey.and.returnValues(of(member), of(updatedMember));
    createComponent();
    fixture.detectChanges();
