...
:::tip[Як це зробити]
Крок за кроком: [Записати провід куреня чи гуртка](/user/howto/assign-leadership/).
:::
...
:::tip[Як це зробити]
Крок за кроком: [Закріпити впорядника за гуртком](/user/howto/assign-mentor/).
:::

## Кілька куренів (заплановано, нереалізовано)

Людина може стояти в кількох куренях одночасно, і в кожному тримати своє діловодство. При вході система
відкриває той курінь, де в людини є діловодство, а перемкнутися можна у меню зверху.
