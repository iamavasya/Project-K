...
![Імпорт складу з таблиці](../images/import-1.png)

![Імпорт складу з таблиці](../images/import-2.png)

## 3. Провід куреня і КВ

- **Провід куреня** — курінний, скарбник, писар та інші діловодства з датами каденцій. Історія
...
![KV-Leadership](../images/kv-leadership.png)
...
![Планування табору](../images/planning-1.png)

![Планування табору](../images/planning-2.png)

## 6. Налаштування куреня
...
![PDF Export](../images/pdf-export.png)
