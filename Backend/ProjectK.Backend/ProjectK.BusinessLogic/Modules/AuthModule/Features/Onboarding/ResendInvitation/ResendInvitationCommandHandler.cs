...
public class ResendInvitationCommandHandler : IRequestHandler<ResendInvitationCommand, ServiceResult<Guid>>
{
    private readonly IUnitOfWork _unitOfWork;
    private readonly IEmailService _emailService;
    private readonly TimeProvider _timeProvider;

    public ResendInvitationCommandHandler(IUnitOfWork unitOfWork, IEmailService emailService, TimeProvider timeProvider)
    {
...
public sealed class ResendInvitationByEmailCommandHandler : IRequestHandler<ResendInvitationByEmailCommand, ServiceResult<bool>>
{
    private readonly UserManager<AppUser> _userManager;
    private readonly IUnitOfWork _unitOfWork;
    private readonly IEmailService _emailService;
    private readonly TimeProvider _timeProvider;
    private readonly ILogger<ResendInvitationByEmailCommandHandler> _logger;

    public ResendInvitationByEmailCommandHandler(
        UserManager<AppUser> userManager,
        IUnitOfWork unitOfWork,
        IEmailService emailService,
        TimeProvider timeProvider,
        ILogger<ResendInvitationByEmailCommandHandler> logger)
    {
