...
public class GetMigrationPreflightReportQueryHandler : IRequestHandler<GetMigrationPreflightReportQuery, ServiceResult<MigrationPreflightReport>>
{
    ...
    public GetMigrationPreflightReportQueryHandler(
