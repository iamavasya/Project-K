...
public sealed record PreviewRosterImport(Stream Content) : IRequest<ServiceResult<RosterPreview>>;
...
public sealed class PreviewRosterImportHandler
    : IRequestHandler<PreviewRosterImport, ServiceResult<RosterPreview>>
{
    /// <summary>
    ...
    public PreviewRosterImportHandler(ISpreadsheetReader reader)
    {
        _reader = reader;
    }

    public Task<ServiceResult<RosterPreview>> Handle(
        PreviewRosterImport request,
