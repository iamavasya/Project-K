...
/// </summary>
public sealed record GetMemberDossier(
    Guid MemberKey,
...
/// </summary>
public sealed class GetMemberDossierHandler
    : IRequestHandler<GetMemberDossier, ServiceResult<MemberDossierResponse>>
{
    ...
    public GetMemberDossierHandler(
