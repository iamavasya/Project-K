...
{
    public class UpsertGroupCommandHandlerTests
    {
        ...
        public UpsertGroupCommandHandlerTests()
        {
            ...
            _handler = new UpsertGroupCommandHandler(_unitOfWorkMock.Object, _mapper);
        }
        ...
        public async Task Handle_WhenCreatingNewGroup_ShouldCreateAndReturnCreated()
        {
            ...
            var command = new UpsertGroupCommand(name, kurin.KurinKey);
        ...
        public async Task Handle_WhenUpdatingExistingGroup_ShouldUpdateAndReturnSuccess()
        {
            ...
            var command = new UpsertGroupCommand(groupKey, newName);
